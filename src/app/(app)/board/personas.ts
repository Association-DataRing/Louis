...
export const PERSONAS: Persona[] = [
  {
    ...
    labelKey: "meta.personas.avocat-affaires.label",
    role: "default-chat",
    emoji: "👨‍💼",
    pitchKey: "meta.personas.avocat-affaires.pitch",
  ...
  },
  {
    ...
    labelKey: "meta.personas.avocat-consommateur.label",
    role: "default-chat",
    emoji: "🛡️",
    pitchKey: "meta.personas.avocat-consommateur.pitch",
  ...
  {
    slug: "dpo",
    labelKey: "meta.personas.dpo.label",
    role: "default-chat",
    emoji: "🔒",
    pitchKey: "meta.personas.dpo.pitch",
  ...
  {
    slug: "compliance",
    labelKey: "meta.personas.compliance.label",
    role: "reviewer",
    emoji: "📋",
    pitchKey: "meta.personas.compliance.pitch",
  ...
  {
    slug: "contradicteur",
    labelKey: "meta.personas.contradicteur.label",
    role: "default-chat",
    emoji: "🎯",
    pitchKey: "meta.personas.contradicteur.pitch",
  ...
  {
    slug: "pragmatique",
    labelKey: "meta.personas.pragmatique.label",
    role: "default-chat",
    emoji: "⚖️",
    pitchKey: "meta.personas.pragmatique.pitch",
  ...
  {
    slug: "fiscaliste",
    labelKey: "meta.personas.fiscaliste.label",
    role: "default-chat",
    emoji: "💰",
    pitchKey: "meta.personas.fiscaliste.pitch",
  ...
  {
    slug: "procedure",
    labelKey: "meta.personas.procedure.label",
    role: "default-chat",
    emoji: "📜",
    pitchKey: "meta.personas.procedure.pitch",
