...
echo "  1. Créer l'org GitHub DataRing"
echo "  2. Transférer D4kooo/louis → DataRing/louis (Settings → Transfer)"
echo "  3. Sed global : voir docs/launch-checklist.md section 'Sed global post-transfert'"
echo "  4. Activer protections branches main + CodeQL Default Setup + Discussions"
echo "  5. Tag v0.1.0 + push --tags"
echo "  6. Créer GitHub Release avec contenu CHANGELOG [Non publié] renommé en [v0.1.0]"
echo "  7. Coller docs/launch-welcome.md dans Discussions 📣 Annonces"
echo "  8. Publier docs/launch-blog-draft.md sur data-ring.net"
echo ""
